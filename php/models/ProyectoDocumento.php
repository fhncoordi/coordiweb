<?php
/**
 * Modelo: ProyectoDocumento
 * Coordicanarias CMS
 *
 * Gestión de documentos adjuntos a proyectos
 */
...
class ProyectoDocumento {
     ...
     */
    public static function getByProyecto($proyecto_id) {
        ...
        return fetchAll($sql, [$proyecto_id]);
    }
    ...
    public static function getById($id) {
        $sql = "SELECT * FROM proyecto_documentos WHERE id = ?";
    ...
    public static function create($datos) {
        $sql = "INSERT INTO proyecto_documentos (
                    proyecto_id, titulo, nombre_original, nombre_archivo, ruta_completa,
    ...
    public static function delete($id) {
        ...
        // Eliminar de BD
        $sql = "DELETE FROM proyecto_documentos WHERE id = ?";
        if (execute($sql, [$id])) {
     ...
     */
    public static function subirDocumento($archivo, $proyecto_id, $titulo) {
        ...
        $nombre_archivo = 'doc_' . $proyecto_id . '_' . uniqid() . '.' . $extension;
     ...
     */
    public static function contar($proyecto_id) {
        $sql = "SELECT COUNT(*) as total FROM proyecto_documentos WHERE proyecto_id = ?";
        $resultado = fetchOne($sql, [$proyecto_id]);
