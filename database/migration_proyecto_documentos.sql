-- Migración: Tabla de documentos adjuntos a proyectos
-- Fecha: 2024-01-27
-- Descripción: Permite a los coordinadores adjuntar documentos a los proyectos
USE coordica_crc;
...
COMMENT='Documentos adjuntos a proyectos (PDFs, imágenes, hojas de cálculo, etc.)';
