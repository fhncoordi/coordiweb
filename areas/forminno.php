<?php
/**
 * Página de Área: Formación e Innovación
 * Coordicanarias CMS
 */
...
<body id="home" class="sticky-bar menu-standard ">
    <div id="lab-main">
                            ...
                            <nav id="lab-main-menu" tabindex="-1" aria-label="Primary menu">
                                <div class="lab-main-menu">
                                    <ul id="menu-main-menu" class="nav-menu">
                                        ...
                                        <li class="menu-item">
                                            <a class="" data-scroll href="#about-fi">Formación e innovación</a>
                                        </li>
                                        <li class="menu-item">
                                            <a class="" data-scroll href="#services-fi">Servicios</a>
                                        </li>
                                        <li class="menu-item">
                                            <a class="" data-scroll href="#portfolios-fi">Proyectos</a>
                                        </li>
                                        <li class="menu-item">
                                            <a class="" data-scroll href="#beneficios-fi">Beneficios</a>
                                        </li>
                                        <li class="menu-item">
                                            <a class="" data-scroll href="#participa-fi">Participa</a>
                                        </li>
                                        <li class="menu-item">
                                    ...
                                    <div class="row">
                                        <div class="lab-offcanvas-menu lab-widget">
                                            <ul id="menu-main-menu-1" class="nav-menu">
                                                ...
                                                <li class="menu-item">
                                                    <a class="" href="#about-fi">Formación e innovación</a>
                                                </li>
                                                <li class="menu-item">
                                                    <a class="" href="#services-fi">Servicios</a>
                                                </li>
                                                <li class="menu-item">
                                                    <a class="" href="#portfolios-fi">Proyectos</a>
                                                </li>
                                                <li class="menu-item">
                                                    <a class="" href="#beneficios-fi">Beneficios</a>
                                                </li>
                                                <li class="menu-item">
                                                    <a class="" data-scroll href="#participa-fi">Participa</a>
                                                </li>
        ...
        <main>
        <!--Jumbotron-->
        <div class="jumbotron_fi" id="jumbotron">
            <h1 class="display-4" style="padding-left: 20px; padding-right: 20px">Formación e innovación</h1>
            <p class="lead" style="padding-bottom: 60px;">Cursos y talleres para el desarrollo de habilidades personales y profesionales</p>
            <!--<hr class="my-4">-->
            <!--<p>Me cago en todo lo que se menea</p>-->
            <!--<a class="wm-button button" href="#about-fi" role="button">Formación e innovación</a>-->
        </div>
        <!--Jumbotron end-->

        <!--About section-->
        <!--Descripción del Área-->
        <section id="about-fi" class="section">
            <div class="main-container">
                <div class="inside-container">
                    <div class="row">
                        <div class="col-12">
                            <h2 style="margin-bottom: 30px;">¿Qué es el área de formación e innovación?</h2>
                            <p style="font-size: 1.1em; line-height: 1.8; margin-bottom: 20px;">
                                El área de formación e innovación de Coordicanarias está dedicada a proporcionar programas
                                formativos y de capacitación diseñados específicamente para personas con discapacidad,
                                sus familias y voluntarios. Trabajamos para desarrollar competencias que faciliten la
                                autonomía personal, la inclusión social y el acceso al empleo.
                            </p>
                            <p style="font-size: 1.1em; line-height: 1.8; margin-bottom: 20px;">
                                Nuestro enfoque combina metodologías innovadoras con la incorporación de nuevas tecnologías,
                                ofreciendo formación actualizada y relevante que responde a las necesidades reales de las
                                personas con discapacidad en un mundo en constante transformación. Cada programa está
                                diseñado con criterios de accesibilidad universal y participación activa.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <!--Servicios section-->
        <section id="services-fi" class="section section-bg">
            <div class="main-container">
                <div class="inside-container">
                    <div class="row">
                        <div class="col-12">
        ...
        <section id="portfolios-fi" class="section">
            <!-- Container Starts -->
            <div class="main-container">
                <div class="inside-container">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-6 mb-4">
                            <article style="background: #f8f8f8; padding: 30px; border-radius: 8px; height: 100%;">
                                <h3 style="margin-bottom: 15px;">DRACAENA 14 - Acciones formativas</h3>
                                <img src="../images/portfolio/dracaena14.jpg" alt="Proyecto: DRACAENA 14" style="width: 100%; height: 250px; object-fit: cover; border-radius: 8px; margin-bottom: 20px;">
                                <p style="margin-bottom: 15px;">
                                    Programa integral de formación para la inserción laboral que incluye certificados de
                                    profesionalidad, especialidades propias en diversos sectores (turismo, tecnología, sanitario,
                                    agrario, energías renovables) y formación a la carta adaptada a empresas colaboradoras.
                                </p>
                                <p>
                                    Este programa combina formación profesional de calidad con itinerarios personalizados,
                                    favoreciendo la empleabilidad y el acceso al mercado laboral de personas con discapacidad.
                                </p>
                            </article>
                        </div>
                        <div class="col-lg-6 mb-4">
                            <article style="background: #f8f8f8; padding: 30px; border-radius: 8px; height: 100%;">
                                <h3 style="margin-bottom: 15px;">Análisis de impacto de la teleasistencia avanzada</h3>
                                <img src="../images/portfolio/teleasistencia_avanzada2.jpg" alt="Proyecto: Impacto de la teleasistencia avanzada" style="width: 100%; height: 250px; object-fit: cover; border-radius: 8px; margin-bottom: 20px;">
                                <p style="margin-bottom: 15px;">
                                    Proyecto de investigación que evalúa la efectividad de los servicios de teleasistencia avanzada
                                    en la mejora de la calidad de vida, autonomía personal y seguridad de las personas usuarias
                                    del servicio, analizando su impacto social y económico.
                                </p>
                                <p>
                                    A través de metodología rigurosa, generamos evidencia sobre los beneficios de la teleasistencia
                                    y contribuimos a la mejora continua de este servicio esencial para la vida independiente.
                                </p>
                            </article>
                        </div>
                    </div>
        ...
        <!--Beneficios-->
        <section id="beneficios-fi" class="section section-bg">
            <div class="main-container">
                <div class="inside-container">
                    <div class="row">
                        <div class="col-12">
        ...
        <!--Contact section-->
        <section id="participa-fi" class="section">
            <div class="main-container section-bg">
                <div class="inside-container">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="contact-con">
                                <h2>¿Cómo puedo acceder a estos proyectos?</h2>
                                <p style="margin-bottom: 10px;">
                                    Si estás interesado en participar en nuestros proyectos de Formación,
                                    el proceso es sencillo:
                                </p>
                                <ol style="line-height: 1.8; margin-bottom: 30px; padding-left: 20px;">
                                    <li style="margin-bottom: 15px;">
                                        <strong>Contacta con nosotros:</strong> Rellena este formulario o llámanos para
                                        expresar tu interés en nuestros programas formativos.
                                    </li>
                                    <li style="margin-bottom: 15px;">
                                        <strong>Entrevista inicial:</strong> Realizaremos una entrevista para conocer tus
                                        intereses, necesidades formativas y expectativas.
                                    </li>
                                    <li style="margin-bottom: 15px;">
                                        <strong>Inscripción en programas:</strong> Te informaremos sobre los cursos y talleres
                                        disponibles y te ayudaremos con el proceso de inscripción.
                                    </li>
                                    <li>
                                        <strong>Comienza tu formación:</strong> Participa en los programas con el apoyo de
                                        nuestro equipo de formadores especializados.
                                    </li>
                                </ol>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="contact-form">
                                <form method="post" action="../php/enviar_correo.php" id="contact-form">
                                    <input type="hidden" name="area" value="formacion">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="txtName" id="name1" class="form-control" placeholder="Type Full Name *" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="email1">Your Email:</label>
                                            <input type="email" name="txtEmail" id="email1" class="form-control" placeholder="Type Email ID *" required />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="txtMsg" id="msg1" class="form-control" placeholder="Type Message *" style="width: 100%; height: 115px;" required></textarea>
                                        </div>
                                        <div class="form-group">
                ...
                <div class="inside-container">
                    <div class="row">
                        <div class="lab-footer-menu">
                            <ul id="footer-menu" class="nav-menu footer-nav">
                                <li class="menu-item">
                                    <a href="../index.html" class="">Inicio</a>
                                </li>
                                <li class="menu-item">
