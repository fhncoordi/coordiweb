...
<body id="home" class="sticky-bar menu-standard ">
    <div id="lab-main">
                            ...
                            <nav id="lab-main-menu" tabindex="-1" aria-label="Primary menu">
                                <div class="lab-main-menu">
                                    <ul id="menu-main-menu" class="nav-menu">
                                        ...
                                        <li class="menu-item">
                                            <a class="" data-scroll href="#news-fi">Noticias</a>
                                        </li>
                                        <?php endif; ?>
                                        <li class="menu-item">
                    ...
                    <div class="row">
                        <?php if (!empty($proyectos)): ?>
                            <?php foreach ($proyectos as $proyecto): ?>
                                ...
                                $documentos_proyecto = ProyectoDocumento::getByProyecto($proyecto['id']);
                                ?>
                                                ...
                                                <a href="../<?= e($doc['ruta_completa']) ?>"
                                                   ...
                                                   onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 6px rgba(0,0,0,0.1)'">
                                                    ...
                                                    <div style="min-width: 55px; text-align: center; margin-right: 20px;">
                                                        <i class="fas <?= ProyectoDocumento::getIcono($doc['extension']) ?>"
                                                           style="font-size: 2.8em; opacity: 0.95;"></i>
                                                    </div>
                                                    ...
                                                    <div style="flex: 1;">
                                                        ...
                                                        <small style="opacity: 0.85; font-size: 0.9em;">
                                                            ...
                                                            <?= ProyectoDocumento::formatearTamano($doc['tamano']) ?>
                                                        </small>
                                                    </div>
                                                    ...
                                                    <div style="min-width: 45px; text-align: center; margin-left: 15px;">
                                                        <i class="fas fa-download"
                                                           style="font-size: 1.6em; opacity: 0.95;"></i>
                                                    </div>
                                                </a>
                                                <?php endforeach; ?>
                                            </div>
        ...
        <!--News section-->
        <?php if (count($noticias) > 0): ?>
        <section id="news-fi" class="section">
            <div class="main-container section-bg">
                <div class="inside-container">
                    <div class="row">
                        <div class="col-12 our-header">
                            <h2>Novedades de Formación e Innovación</h2>
                        </div>
                    </div>
                    <div class="row">
