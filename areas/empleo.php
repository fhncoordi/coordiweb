...
<body id="home" class="sticky-bar menu-standard ">
    <div id="lab-main">
                            ...
                            <nav id="lab-main-menu" tabindex="-1" aria-label="Primary menu">
                                <div class="lab-main-menu">
                                    <ul id="menu-main-menu" class="nav-menu">
                                        ...
                                        <li class="menu-item">
                                            <a class="" data-scroll href="#about-em">Empleo</a>
                                        </li>
                                        <li class="menu-item">
                                            <a class="" data-scroll href="#services-em">Servicios</a>
                                        </li>
                                        <li class="menu-item">
                                    ...
                                    <div class="row">
                                        <div class="lab-offcanvas-menu lab-widget">
                                            <ul id="menu-main-menu-1" class="nav-menu">
                                                ...
                                                <li class="menu-item">
                                                    <a class="" href="#about-em">Empleo</a>
                                                </li>
                                                <li class="menu-item">
                                                    <a class="" href="#services-em">Servicios</a>
                                                </li>
                                                <li class="menu-item">
                                                    <a class="" href="#portfolios-em">Proyectos</a>
                                                </li>
                                                <li class="menu-item">
        ...
        <main>
        <!--Jumbotron-->
        <div class="jumbotron_em" id="jumbotron">
            <h1 class="display-4" style="padding-left: 20px; padding-right: 20px">Empleo</h1>
            <p class="lead" style="padding-bottom: 60px;">Orientación, formación y apoyo para la inclusión laboral de personas con discapacidad</p>
            <!--<hr class="my-4">-->
            <!--<p>Me cago en todo lo que se menea</p>-->
            <!--<a class="wm-button button" href="#about-em" role="button">Empleo</a>-->
        </div>
        <!--Jumbotron end-->

        <!--About section-->
        <!--Descripción del Área-->
        <section id="about-em" class="section">
            <div class="main-container">
                <div class="inside-container">
                    <div class="row">
                        <div class="col-12">
                            <h2 style="margin-bottom: 30px;">¿Qué es el area de Empleo?</h2>
                            <p style="font-size: 1.1em; line-height: 1.8; margin-bottom: 20px;">
                                El área de Empleo de Coordicanarias está dedicada a facilitar la inclusión laboral de las personas
                                con discapacidad a través de servicios especializados de orientación, formación y acompañamiento.
                                Trabajamos para eliminar barreras y crear oportunidades reales de empleo que permitan el desarrollo
                                profesional y personal de cada individuo.
                            </p>
                            <p style="font-size: 1.1em; line-height: 1.8; margin-bottom: 20px;">
                                Nuestro equipo de profesionales especializados en orientación laboral e inserción sociolaboral
                                ofrece un acompañamiento integral, desde la preparación para el empleo hasta el seguimiento
                                en el puesto de trabajo, garantizando una transición plena al mundo laboral.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <!--Servicios section-->
        <section id="services-em" class="section section-bg">
            <div class="main-container">
                <div class="inside-container">
                    <div class="row">
                        <div class="col-12">
        ...
        <section id="portfolios-em" class="section">
            <!-- Container Starts -->
            <div class="main-container">
                <div class="inside-container">
                    <div class="row">
        ...
        <!--Beneficios-->
        <section id="beneficios-em" class="section section-bg">
            <div class="main-container">
                <div class="inside-container">
                    <div class="row">
                        <div class="col-12">
        ...
        <!--News section-->
        <?php if (count($noticias) > 0): ?>
        <section id="news-em" class="section">
            <div class="main-container section-bg">
                <div class="inside-container">
                    <div class="row">
                        <div class="col-12 our-header">
                            <h2>Novedades de Empleo</h2>
                        </div>
                    </div>
                    <div class="row">
        ...
        <!--Contact section-->
        <section id="participa-em" class="section">
            <div class="main-container section-bg">
                <div class="inside-container">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="contact-con">
                                ...
                                <p style="margin-bottom: 10px;">
                                    Si estás interesado en participar en nuestros proyectos de empleo,
                                ...
                                <ol style="line-height: 1.8; margin-bottom: 30px; padding-left: 20px;">
                                    ...
                                    <li style="margin-bottom: 15px;">
                                        <strong>Entrevista inicial:</strong> Realizaremos una primera entrevista para conocer tu
                                        situación, experiencia y objetivos profesionales.
                                    </li>
                                    <li style="margin-bottom: 15px;">
                                        <strong>Plan personalizado:</strong> Diseñaremos juntos un itinerario de inserción laboral
                                        adaptado a tus necesidades y aspiraciones.
                                    </li>
                                    <li>
                                        <strong>Acompañamiento continuo:</strong> Te acompañaremos en cada paso del proceso hasta
                                        conseguir tu inserción laboral y consolidación en el empleo.
                                    </li>
                                </ol>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="contact-form">
                                <form method="post" action="../php/enviar_correo.php" id="contact-form">
                                    <input type="hidden" name="area" value="empleo">
