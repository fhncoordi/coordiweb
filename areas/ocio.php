...
<head>
    ...
    <title>Coordicanarias - Ocio y Tiempo Libre</title>
...
<div id="lab-main">
                        ...
                        <nav id="lab-main-menu" tabindex="-1" aria-label="Primary menu">
                            <div class="lab-main-menu">
                                <ul id="menu-main-menu" class="nav-menu">
                                    ...
                                    <li class="menu-item">
                                        <a class="" data-scroll href="#about-o">Ocio</a>
                                    </li>
                                    <li class="menu-item">
                                        <a class="" data-scroll href="#services-o">Servicios</a>
                                    </li>
                                    <li class="menu-item">
                                ...
                                <div class="row">
                                    <div class="lab-offcanvas-menu lab-widget">
                                        <ul id="menu-main-menu-1" class="nav-menu">
                                            ...
                                            <li class="menu-item">
                                                <a class="" href="#about-o">Ocio</a>
                                            </li>
                                            <li class="menu-item">
                                                <a class="" href="#services-o">Servicios</a>
                                            </li>
                                            <li class="menu-item">
                                                <a class="" href="#portfolios-o">Proyectos</a>
                                            </li>
                                            <li class="menu-item">
    ...
    <main>
    <!--Jumbotron-->
    <div class="jumbotron_o" id="jumbotron">
        <h1 class="display-4" style="padding-left: 20px; padding-right: 20px">Ocio y tiempo libre</h1>
        <p class="lead" style="padding-bottom: 60px;">Actividades recreativas, culturales y deportivas para el disfrute y la inclusión social</p>
    </div>
    <!--Jumbotron end-->

    <!--About section-->
    <!--Descripción del Área-->
    <section id="about-o" class="section">
        <div class="main-container">
            <div class="inside-container">
                <div class="row">
                    <div class="col-12">
                        <h2 style="margin-bottom: 30px;">¿Qué es el área de Ocio y tiempo libre?</h2>
                        <p style="font-size: 1.1em; line-height: 1.8; margin-bottom: 20px;">
                            El área de Ocio y tiempo libre de Coordicanarias promueve la participación de las personas
                            con discapacidad en actividades recreativas, culturales y turísticas. Creemos
                            firmemente en el derecho al ocio como elemento fundamental para la calidad de vida, el bienestar
                            personal y la inclusión social.
                        </p>
                        <p style="font-size: 1.1em; line-height: 1.8; margin-bottom: 20px;">
                            Nuestros programas están diseñados para ser plenamente accesibles, adaptándose a las necesidades
                            de cada persona y favoreciendo espacios de encuentro, diversión y desarrollo personal en un
                            entorno inclusivo y enriquecedor.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <!--Servicios section-->
    <section id="services-o" class="section section-bg">
        <div class="main-container">
            <div class="inside-container">
                <div class="row">
                    <div class="col-12">
    ...
    <section id="portfolios-o" class="section">
        <!-- Container Starts -->
        <div class="main-container">
            <div class="inside-container">
                <div class="row">
    ...
    <!--Beneficios-->
    <section id="beneficios-o" class="section section-bg">
        <div class="main-container">
            <div class="inside-container">
                <div class="row">
                    <div class="col-12">
    ...
    <!--Contact section-->
    <section id="participa-o" class="section">
                    ...
                    <div class="col-md-6">
                        <div class="contact-con">
                            ...
                            <p style="margin-bottom: 10px;">
                                Si estás interesado en participar en nuestras actividades de ocio y tiempo libre,
                                el proceso es muy sencillo:
                            </p>
                            <ol style="line-height: 1.8; margin-bottom: 30px; padding-left: 20px;">
                                <li style="margin-bottom: 15px;">
                                    <strong>Contacta con nosotros:</strong> Rellena este formulario o llámanos para conocer
                                    las actividades disponibles.
                                </li>
                                <li style="margin-bottom: 15px;">
                                    <strong>Elige tu actividad:</strong> Te informaremos sobre las próximas actividades
                                    programadas y podrás elegir las que más te interesen.
                                </li>
                                <li style="margin-bottom: 15px;">
                                    <strong>Inscríbete:</strong> Te ayudaremos con el proceso de inscripción y te daremos
                                    toda la información necesaria sobre la actividad.
                                </li>
                                <li style="margin-bottom: 15px;">
                                    <strong>¡Disfruta!:</strong> Participa en las actividades, conoce gente nueva y
                                    vive experiencias inolvidables en un entorno accesible e inclusivo.
                                </li>
                            </ol>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="contact-form">
                            <form method="post" action="../php/enviar_correo.php" id="contact-form">
                                <input type="hidden" name="area" value="ocio">
