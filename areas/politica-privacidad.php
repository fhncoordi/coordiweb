...
<head>
    ...
    <title>Política de Privacidad - Coordicanarias</title>
    <!-- Font Awesome Icons -->
...
<body id="home" class="sticky-bar menu-standard ">
    <div id="lab-main">
                            ...
                            <nav id="lab-main-menu" tabindex="-1" aria-label="Primary menu">
                                <div class="lab-main-menu">
                                    <ul id="menu-main-menu" class="nav-menu">
                                        ...
                                        <li class="menu-item">
                                            <a class="" data-scroll href="#objeto-pp">Objeto</a>
                                        </li>
                                        <li class="menu-item">
                                            <a class="" data-scroll href="#politica-privacidad">Política de Privacidad</a>
                                        </li>
                                        <li class="menu-item">
                                            <a class="" data-scroll href="#contacto-pp">Contacto</a>
                                        </li>
                                        <li class="menu-item">
                                    ...
                                    <div class="row">
                                        <div class="lab-offcanvas-menu lab-widget">
                                            <ul id="menu-main-menu-1" class="nav-menu">
                                                ...
                                                <li class="menu-item">
                                                    <a class="" href="#politica-privacidad">Política de Privacidad</a>
                                                </li>
                                                <li class="menu-item">
                                                    <a class="" data-scroll href="#contacto-pp">Contacto</a>
                                                </li>
        ...
        <div class="jumbotron_index" id="jumbotron">
            <h1 class="display-4" style="padding-left: 20px; padding-right: 20px">Política de Privacidad</h1>
            <p class="lead" style="padding-bottom: 60px;">Protección de datos personales y derechos de los usuarios</p>
            <!--<hr class="my-4">-->
        ...
        <!--Objeto section-->
        <section id="objeto-pp" class="section section-bg">
            <div class="main-container">
                <div class="inside-container">
                    <div class="row">
                        <div class="col-12">
                            <h2 style="margin-bottom: 40px;">Objeto</h2>
                        </div>
                    </div>
                    <div class="row">
                        <p>La presente Política de Privacidad regula el tratamiento de los datos personales que los usuarios facilitan a COORDICANARIAS (Coordinadora de Personas con Discapacidad Física de Canarias) a través del sitio web <strong>coordicanarias.com</strong>.</p>
                        <p>COORDICANARIAS se compromete a cumplir con la legislación vigente en materia de protección de datos de carácter personal, especialmente el Reglamento (UE) 2016/679 del Parlamento Europeo y del Consejo, de 27 de abril de 2016, relativo a la protección de las personas físicas en lo que respecta al tratamiento de datos personales (RGPD) y la Ley Orgánica 3/2018, de 5 de diciembre, de Protección de Datos Personales y garantía de los derechos digitales (LOPDGDD).</p>
                        <p>Esta política tiene por objeto informarle de manera clara y transparente sobre el tratamiento de sus datos personales, los derechos que le asisten y cómo ejercitarlos.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <!--Main Content-->
        <section id="politica-privacidad" class="section">
            <div class="main-container">
                <div class="inside-container">
                    <div class="col-12">
                        <h2 style="margin-bottom: 30px;">Política de Privacidad</h2>
                    </div>
                    <!--Category Tabs-->
                    <div class="category-tabs">

                        <ul class="nav nav-tabs-transparency" role="tablist" aria-label="Secciones de política de privacidad">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active"
                                        id="responsable-tab"
                                        type="button"
                                        role="tab"
                                        aria-controls="responsable-pp"
                                        aria-selected="true"
                                        data-target="#responsable-pp">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link"
                                        ...
                                        type="button"
                                        role="tab"
                                        aria-controls="datos-pp"
                                        aria-selected="false"
                                        data-target="#datos-pp">
                                    <i class="fas fa-database tab-icon" aria-hidden="true"></i>
                                    <span>Datos y finalidad</span>
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link"
                                        ...
                                        type="button"
                                        role="tab"
                                        aria-controls="derechos-pp"
                                        aria-selected="false"
                                        data-target="#derechos-pp">
                                    <i class="fas fa-user-shield tab-icon" aria-hidden="true"></i>
                                    <span>Derechos</span>
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link"
                                        ...
                                        type="button"
                                        role="tab"
                                        aria-controls="seguridad-pp"
                                        aria-selected="false"
                                        data-target="#seguridad-pp">
                                    <i class="fas fa-lock tab-icon" aria-hidden="true"></i>
                                    <span>Seguridad y conservación</span>
                                </button>
                            </li>
                        </ul>
                        ...
                        <!--TAB 1: RESPONSABLE DEL TRATAMIENTO-->
                        <div class="tab-pane fade show active" id="responsable-pp" role="tabpanel" aria-labelledby="responsable-tab">
        ...
        <section class="section">
            <div class="main-container">
                <div class="inside-container">
                    <div class="row">
                        <div class="col-12">
                            <h2 style="margin-bottom: 40px;">Responsable del tratamiento</h2>
                        </div>
                    </div>
                    <div class="row">
                        <h3>Identificación del responsable</h3>
                        <p>De conformidad con lo establecido en el Reglamento (UE) 2016/679 (RGPD) y la Ley Orgánica 3/2018 (LOPDGDD), el responsable del tratamiento de los datos personales recogidos a través de este sitio web es:</p>
                        ...
                        <div class="contact-info" style="margin: 20px 0;">
                            ...
                            <p><strong>Domicilio Social:</strong> C/ Zurbarán, 7, Local 3, Los Andenes 38108<br>San Cristóbal de La Laguna, Santa Cruz de Tenerife</p>
                            <p><strong>Teléfono:</strong> 922 21 59 09</p>
                            <p><strong>Email de contacto:</strong> <a href="mailto:info@coordicanarias.com">info@coordicanarias.com</a></p>
                            <p><strong>Sitio Web:</strong> <a href="https://coordicanarias.com" target="_blank">https://coordicanarias.com</a></p>
                        </div>

                        <h3>Delegado de Protección de Datos</h3>
                        <p>Puede contactar con el Delegado de Protección de Datos (DPD) de COORDICANARIAS en la dirección de correo electrónico: <a href="mailto:info@coordicanarias.com">info@coordicanarias.com</a></p>

                        <h3>Finalidad del tratamiento</h3>
                        <p>COORDICANARIAS trata los datos personales que los usuarios facilitan voluntariamente a través de los formularios de contacto y otros medios disponibles en el sitio web con las siguientes finalidades:</p>
                        <ul>
                            <li>Gestionar las consultas, solicitudes de información y comunicaciones recibidas a través del sitio web.</li>
                            <li>Informar sobre servicios, actividades y noticias de COORDICANARIAS que puedan ser de interés para el usuario.</li>
                            <li>Gestionar la participación en programas, servicios y actividades ofrecidas por la entidad.</li>
                            <li>Cumplir con las obligaciones legales aplicables a la actividad de COORDICANARIAS.</li>
                        </ul>
                    </div>
                </div>
            </div>
        </section>
        <!--Responsable end section-->

                        </div>
                        <!--TAB 1 END-->

                        <!--TAB 2: DATOS Y FINALIDAD-->
                        <div class="tab-pane fade" id="datos-pp" role="tabpanel" aria-labelledby="datos-tab">
        ...
        <section class="section section-bg">
            <div class="main-container">
                <div class="inside-container">
                    <div class="row">
                        <div class="col-12">
                            <h2 style="margin-bottom: 40px;">Datos personales y finalidad del tratamiento</h2>
                        </div>
                    </div>
                    <div class="row">
                        <h3>Datos que recogemos</h3>
                        <p>COORDICANARIAS recoge y trata los siguientes datos personales que los usuarios facilitan voluntariamente:</p>
                        <ul>
                            ...
                            <li><strong>Datos de la consulta:</strong> Información proporcionada en los formularios de contacto o solicitudes de información</li>
                            <li><strong>Datos técnicos de navegación:</strong> Dirección IP, tipo de navegador, idioma, fecha y hora de acceso (a través de cookies)</li>
                        </ul>

                        <h3>Finalidad del tratamiento</h3>
                        <p>Los datos personales serán tratados para las siguientes finalidades:</p>
                        <ul>
                            <li>Atender y responder a las consultas, solicitudes de información y comunicaciones recibidas.</li>
                            <li>Gestionar la participación en los programas, servicios y actividades de COORDICANARIAS.</li>
                            <li>Enviar comunicaciones informativas sobre servicios, actividades, noticias y eventos de la organización.</li>
                            <li>Mejorar la calidad de los servicios prestados y la experiencia de usuario en el sitio web.</li>
                        ...
                        <ul>
                            <li><strong>Consentimiento del interesado</strong> (artículo 6.1.a RGPD): Al cumplimentar los formularios de contacto o suscribirse a comunicaciones.</li>
                            <li><strong>Ejecución de un contrato o aplicación de medidas precontractuales</strong> (artículo 6.1.b RGPD): Para la gestión de servicios solicitados.</li>
                            <li><strong>Interés legítimo del responsable</strong> (artículo 6.1.f RGPD): Para el envío de comunicaciones sobre actividades de la entidad relacionadas con su misión social.</li>
                            <li><strong>Cumplimiento de obligaciones legales</strong> (artículo 6.1.c RGPD): Para atender requerimientos legales.</li>
                        </ul>
                        ...
                        <ul>
                            ...
                            <li>A proveedores de servicios tecnológicos necesarios para el funcionamiento del sitio web (hosting, email marketing), que actúan como encargados del tratamiento bajo contrato.</li>
                            <li>A organismos públicos cuando sea necesario para el cumplimiento de las funciones de COORDICANARIAS.</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <!--Datos end-->
                        ...
                        <div class="tab-pane fade" id="derechos-pp" role="tabpanel" aria-labelledby="derechos-tab">
        ...
        <section class="section">
            <div class="main-container">
                <div class="inside-container">
                    <div class="row">
                        <div class="col-12">
                            <h2 style="margin-bottom: 40px;">Derechos de las personas usuarias</h2>
                        </div>
                    </div>
                    <div class="row">
                        <p>De conformidad con el RGPD y la LOPDGDD, cualquier persona tiene derecho a obtener confirmación sobre si en COORDICANARIAS estamos tratando datos personales que le conciernen, o no.</p>

                        <h3>Derechos que le asisten</h3>
                        <p>Las personas interesadas tienen derecho a:</p>

                        <ul>
                            <li><strong>Derecho de acceso:</strong> Conocer qué datos personales estamos tratando y obtener una copia de los mismos.</li>
                            <li><strong>Derecho de rectificación:</strong> Solicitar la corrección de datos inexactos o incompletos.</li>
                            <li><strong>Derecho de supresión ("derecho al olvido"):</strong> Solicitar la eliminación de sus datos cuando ya no sean necesarios para los fines para los que fueron recogidos, cuando retire su consentimiento, o cuando se oponga al tratamiento.</li>
                            <li><strong>Derecho a la limitación del tratamiento:</strong> Solicitar que se suspendan las operaciones de tratamiento de sus datos en determinadas circunstancias.</li>
                            <li><strong>Derecho a la portabilidad:</strong> Recibir los datos personales que haya facilitado en un formato estructurado, de uso común y lectura mecánica, y transmitirlos a otro responsable.</li>
                            <li><strong>Derecho de oposición:</strong> Oponerse en cualquier momento, por motivos relacionados con su situación particular, al tratamiento de sus datos personales.</li>
                            <li><strong>Derecho a no ser objeto de decisiones individuales automatizadas:</strong> A no ser objeto de una decisión basada únicamente en el tratamiento automatizado que produzca efectos jurídicos o le afecte significativamente.</li>
                        </ul>

                        <h3>Cómo ejercer sus derechos</h3>
                        <p>Puede ejercer estos derechos de forma gratuita mediante comunicación dirigida a:</p>
                        <div class="contact-info" style="margin: 20px 0;">
                            <p><strong>Dirección postal:</strong> C/ Zurbarán, 7, Local 3, Los Andenes 38108, San Cristóbal de La Laguna, Santa Cruz de Tenerife</p>
                        ...
                        <ul>
                            ...
                            <li>Fotocopia del DNI/NIE u otro documento que acredite su identidad</li>
                        ...
                        <p>Si considera que el tratamiento de sus datos personales vulnera la normativa, tiene derecho a presentar una reclamación ante la Agencia Española de Protección de Datos (AEPD):</p>
                        <div class="contact-info" style="margin: 20px 0;">
                            ...
                            <p>Web: <a href="https://www.aepd.es" target="_blank" rel="noopener">www.aepd.es</a></p>
                        </div>
                    </div>
                </div>
            </div>
        </section>
        <!--Derechos end section-->

                        </div>
                        <!--TAB 3 END-->

                        <!--TAB 4: SEGURIDAD Y CONSERVACIÓN-->
                        <div class="tab-pane fade" id="seguridad-pp" role="tabpanel" aria-labelledby="seguridad-tab">
        ...
        <section class="section section-bg">
            <div class="main-container">
                <div class="inside-container">
                    <div class="row">
                        <div class="col-12">
                            <h2 style="margin-bottom: 40px;">Seguridad y conservación de datos</h2>
                        </div>
                    </div>
                    <div class="row">
                        <h3>Medidas de seguridad</h3>
                        <p>COORDICANARIAS ha adoptado las medidas técnicas y organizativas necesarias para garantizar la seguridad de los datos personales y evitar su alteración, pérdida, tratamiento o acceso no autorizado, habida cuenta del estado de la tecnología, la naturaleza de los datos almacenados y los riesgos a que están expuestos.</p>

                        <p>Entre las medidas implementadas se incluyen:</p>
                        <ul>
                            <li>Cifrado de comunicaciones mediante protocolo SSL/TLS</li>
                            ...
                            <li>Políticas de privacidad y procedimientos internos</li>
                        </ul>

                        <h3>Plazo de conservación</h3>
                        <p>Los datos personales proporcionados se conservarán durante el tiempo necesario para cumplir con la finalidad para la que se recabaron y para determinar las posibles responsabilidades que se pudieran derivar de dicha finalidad y del tratamiento de los datos:</p>

                        <ul>
                            <li><strong>Datos de contacto:</strong> Mientras no se solicite su supresión por el interesado.</li>
                            <li><strong>Datos de suscripción a comunicaciones:</strong> Hasta que se revoque el consentimiento.</li>
                            <li><strong>Datos de participantes en programas:</strong> Durante la participación en el programa y hasta 5 años después para atender posibles responsabilidades.</li>
                            <li><strong>Datos contables y fiscales:</strong> Mínimo 6 años conforme a la legislación fiscal.</li>
                        </ul>

                        <p>Transcurridos los plazos de conservación aplicables, los datos personales serán eliminados de forma segura o anonimizados.</p>

                        <h3>Exactitud y veracidad de los datos</h3>
                        <p>El usuario garantiza que los datos personales facilitados son veraces y exactos, y se compromete a comunicar cualquier modificación de los mismos. El usuario será responsable de cualquier daño o perjuicio, directo o indirecto, que pudiera ocasionarse como consecuencia del incumplimiento de tal obligación.</p>

                        <h3>Confidencialidad</h3>
                        <p>COORDICANARIAS se compromete a guardar secreto profesional respecto de los datos personales y a garantizar el deber de guardarlos adoptando todas las medidas necesarias que eviten su alteración, pérdida, tratamiento o acceso no autorizado.</p>

                        <h3>Actualización de la política</h3>
                        <p>COORDICANARIAS se reserva el derecho a modificar la presente Política de Privacidad para adaptarla a novedades legislativas, jurisprudenciales o de interpretación de la Agencia Española de Protección de Datos. En caso de que se introduzcan cambios sustanciales, se notificará a los usuarios a través del sitio web o mediante comunicación al correo electrónico facilitado.</p>
        ...
        <!--Contact section-->
        <section id="contacto-pp" class="section">
            <div class="main-container">
                <div class="inside-container">
                    <div class="row">
                        <div class="col-md-6">
