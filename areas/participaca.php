...
<div id="lab-main">
                        ...
                        <nav id="lab-main-menu" tabindex="-1" aria-label="Primary menu">
                            <div class="lab-main-menu">
                                <ul id="menu-main-menu" class="nav-menu">
                                    ...
                                    <li class="menu-item">
                                        <a class="" data-scroll href="#news-pa">Noticias</a>
                                    </li>
                                    <?php endif; ?>
                                    <li class="menu-item">
                                ...
                                <div class="row">
                                    <div class="lab-offcanvas-menu lab-widget">
                                        <ul id="menu-main-menu-1" class="nav-menu">
                                            ...
                                            <?php if (count($noticias) > 0): ?>
                                            <li class="menu-item">
                                                <a class="" href="#news-pa">Noticias</a>
                                            </li>
                                            <?php endif; ?>
                                            <li class="menu-item">
                                                <a class="" data-scroll href="#participa-pca">Participa</a>
    ...
    <!--Beneficios end-->
        ...
        <!--News section-->
        <?php if (count($noticias) > 0): ?>
        <section id="news-pa" class="section">
            <div class="main-container section-bg">
                <div class="inside-container">
                    <div class="row">
                        <div class="col-12 our-header">
                            <h2>Novedades de Participación Ciudadana y Accesibilidad</h2>
                        </div>
                    </div>
                    <div class="row">
